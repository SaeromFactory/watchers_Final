            ...
            <div class="section text-center">
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto">
                        ...
                        <p class="description" style="font-family: 나눔바른고딕;">'WATCHERS'의 문의 게시글입니다.<br/></p>
                    </div>
                </div>
                    ...
                    <div class="contact-wrap">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <form action="/contact_update" method="post">
                                ...
                                <span class="gRight">
                                <a class="btn btn-primary btn-round" href="${pageContext.request.contextPath}/contact_update/<%=row.idx%>">글 수정하기</a>
                                <a href="${pageContext.request.contextPath}/contact_delete?idx=<%=row.idx%>"><button type="button" class="btn btn-primary btn-round">글 삭제하기</button></a>
                                    </span><br>
                            </form>
                        </div>
                    </div>
